...
#       if controller is Admin::Xxx
#         <%= sort_header_tag('id', :controller_name => "xxx")%>
#     </tr>
#   </thead>
#
...
module SortHelper
  ...
  def sort_header_tag(column, options = {})
    ...
    content_tag('th', sort_link(column, caption, default_order,options[:controller_name],options[:update]), options)
  end
