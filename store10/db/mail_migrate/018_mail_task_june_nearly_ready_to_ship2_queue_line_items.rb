class MailTaskJuneNearlyReadyToShip2QueueLineItems < ActiveRecord::Migration
  def self.up
    create_table "mail_task_june_nearly_ready_to_ship2_queue_line_items", :force => true do |t|
      t.column "mail_task_june_nearly_ready_to_ship2_queue_id", :integer
  ...
  def self.down
    drop_table :mail_task_june_nearly_ready_to_ship2_queue_line_items
  end
end