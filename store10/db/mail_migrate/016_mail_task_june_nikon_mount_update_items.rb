class MailTaskJuneNikonMountUpdateItems < ActiveRecord::Migration
  def self.up
     create_table "mail_task_june_nikon_mount_update_items", :force => true do |t|
  ...
  def self.down
    drop_table :mail_task_june_nikon_mount_update_items
  end
end