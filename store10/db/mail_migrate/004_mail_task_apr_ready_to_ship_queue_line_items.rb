class MailTaskAprReadyToShipQueueLineItems < ActiveRecord::Migration
  def self.up
    create_table "mail_task_apr_ready_to_ship_queue_line_items", :force => true do |t|
      t.column "mail_task_apr_ready_to_ship_queue_id", :integer
  ...
  def self.down
    drop_table :mail_task_apr_ready_to_ship_queue_line_items
  end
end
