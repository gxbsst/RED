class MailTaskJulyReadyToShipQueues < ActiveRecord::Migration
  def self.up
    create_table :mail_task_july_ready_to_ship_queues, :force => true do |t|
    ...
    create_table :mail_task_july_ready_to_ship_queue_line_items, :force => true do |t|
      t.column "mail_task_july_ready_to_ship_queue_id", :integer
  ...
  def self.down
    drop_table :mail_task_july_ready_to_ship_queue_line_items
    drop_table :mail_task_july_ready_to_ship_queues
  end
end