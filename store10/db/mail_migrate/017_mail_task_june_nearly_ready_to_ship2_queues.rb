class MailTaskJuneNearlyReadyToShip2Queues < ActiveRecord::Migration
  def self.up
    create_table "mail_task_june_nearly_ready_to_ship2_queues", :force => true do |t|
  ...
  def self.down
    drop_table :mail_task_june_nearly_ready_to_ship2_queues
  end
end