class MailTaskJuneRedOneDeliveryLastCallQueues < ActiveRecord::Migration
  def self.up
      create_table "mail_task_june_red_one_delivery_last_call_queues", :force => true do |t|
  ...
  def self.down
    drop_table :mail_task_june_red_one_delivery_last_call_queues
  end
end