class MailTaskMayForRedDayInvitedQueues < ActiveRecord::Migration
  def self.up
      create_table "mail_task_may_for_red_day_invited_queues", :force => true do |t|
  ...
  def self.down
    drop_table :mail_task_may_for_red_day_invited_queues
  end
end