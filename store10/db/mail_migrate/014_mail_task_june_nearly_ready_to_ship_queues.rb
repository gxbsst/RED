class MailTaskJuneNearlyReadyToShipQueues < ActiveRecord::Migration
  def self.up
    create_table "mail_task_june_nearly_ready_to_ship_queues", :force => true do |t|
  ...
  def self.down
    drop_table :mail_task_june_nearly_ready_to_ship_queues
  end
end