class MailTaskApr2ReadyToShipQueueLineItem < ActiveRecord::Base
  include MailTask::General
  belongs_to :mail_task_apr2_ready_to_ship_queue
end

class MailTaskApr2ReadyToShipQueue < ActiveRecord::Base
  include MailTask::General
  
  belongs_to :mail_task
  has_many :mail_task_apr2_ready_to_ship_queue_line_items, :dependent => :destroy
