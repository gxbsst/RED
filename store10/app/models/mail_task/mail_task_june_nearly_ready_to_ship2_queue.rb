class MailTaskJuneNearlyReadyToShip2QueueLineItem < ActiveRecord::Base
  include MailTask::General
  belongs_to :mail_task_june_nearly_ready_to_ship_queue
end

class MailTaskJuneNearlyReadyToShip2Queue < ActiveRecord::Base
  belongs_to :mail_task
  include MailTask::General
  has_many :mail_task_june_nearly_ready_to_ship2_queue_line_items, :dependent => :destroy
    Delivery_range_begin = 2101 
    Delivery_range_end   = 2200
