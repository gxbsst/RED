class MailTaskAprReadyToShipQueueLineItem < ActiveRecord::Base
  include MailTask::General
  belongs_to :mail_task_apr_ready_to_ship_queue
end

class MailTaskAprReadyToShipQueue < ActiveRecord::Base
  include MailTask::General
