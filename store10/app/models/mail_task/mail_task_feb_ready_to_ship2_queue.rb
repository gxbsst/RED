class MailTaskFebReadyToShip2QueueLineItem < ActiveRecord::Base
  include MailTask::MailDB
  belongs_to :mail_task_feb_ready_to_ship2_queue
end

class MailTaskFebReadyToShip2Queue < ActiveRecord::Base
  include MailTask::General
  
  belongs_to :mail_task
  has_many :mail_task_feb_ready_to_ship2_queue_line_items, :dependent => :destroy
