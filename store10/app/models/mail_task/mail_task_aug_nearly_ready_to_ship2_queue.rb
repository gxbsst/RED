class MailTaskAugNearlyReadyToShip2QueueLineItem < ActiveRecord::Base
  include MailTask::General
  belongs_to :mail_task_aug_nearly_ready_to_ship2_queue
end

class MailTaskAugNearlyReadyToShip2Queue < ActiveRecord::Base
  belongs_to :mail_task
  include MailTask::General
  has_many :mail_task_aug_nearly_ready_to_ship2_queue_line_items, :dependent => :destroy
 ...
 #        puts %(The Change of assign to : #{change_about_assign_to} )
