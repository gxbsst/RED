class MailTaskJulyReadyToShipQueueLineItem < ActiveRecord::Base
  include MailTask::General
  belongs_to :mail_task_july_ready_to_ship_queue
end

class MailTaskJulyReadyToShipQueue < ActiveRecord::Base
  belongs_to :mail_task
  include MailTask::General
  has_many :mail_task_july_ready_to_ship_queue_line_items, :dependent => :destroy
