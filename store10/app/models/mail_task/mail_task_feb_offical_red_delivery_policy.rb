class MailTaskFebOfficalRedDeliveryPolicy < ActiveRecord::Base
  ...
  class << self
    def init_queues
      ...
      line_items = AxOrderLineItem.find(:all, :conditions => ['item_id = ? and invoiced_in_total is ?', Product::REDONE_ERP_PRODUCT_ITEM, nil])
  ...
  def send_mail
    options = {
      :subject => "Official RED Delivery Policy",
