class MailTaskJuneReadyToShip2QueueLineItem < ActiveRecord::Base
  include MailTask::General
  belongs_to :mail_task_june_ready_to_ship2_queue
end

class MailTaskJuneReadyToShip2Queue < ActiveRecord::Base
  belongs_to :mail_task
  include MailTask::General
  has_many :mail_task_june_ready_to_ship2_queue_line_items, :dependent => :destroy
