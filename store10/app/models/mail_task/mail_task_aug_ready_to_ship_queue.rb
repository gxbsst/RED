class MailTaskAugReadyToShipQueueLineItem < ActiveRecord::Base
  include MailTask::General
  belongs_to :mail_task_aug_ready_to_ship_queue
end

class MailTaskAugReadyToShipQueue < ActiveRecord::Base
  belongs_to :mail_task
  include MailTask::General
  has_many :mail_task_aug_ready_to_ship_queue_line_items, :dependent => :destroy
